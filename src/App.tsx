    ...
    <div className="min-h-screen tech-background text-white p-4">
      ...
      <section id="projects" className={sectionClasses}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="glass-card rounded-lg overflow-hidden shadow-xl hover:shadow-violet-500/20 hover:scale-105 transition-all duration-300">
            <img 
          ...
          <div className="glass-card rounded-lg overflow-hidden shadow-xl hover:shadow-violet-500/20 hover:scale-105 transition-all duration-300">
            ...
            />
            <div className="p-6">
              <h3 className="text-xl font-semibold mb-2">Online Blogging System</h3>
